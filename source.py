...
#settings
SafeMines = settings["mines"]["right"]
TileMines = settings["mines"]["wrong"]
SafeTowers = settings["towers"]["right"]
TileTowers = settings["towers"]["wrong"]
BotToken = settings["discord"]["token"]
ServerId = int(settings["discord"]["serverid"])
BuyerRoleId = int(settings["discord"]["roleid"])
